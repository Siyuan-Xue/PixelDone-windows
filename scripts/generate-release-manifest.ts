...
const fileName = 'PixelDone_3.2.5_x64-setup.exe';
...
writeFileSync(join(directory, 'latest.json'), `${JSON.stringify({
  version: '3.2.5',
  notes: 'PixelDone for Windows 3.2.5 aligns multilingual typography with Android and introduces a focused account dialog.',
  pub_date: new Date().toISOString(),
  platforms: {
    'windows-x86_64': {
      signature,
      url: `https://github.com/Siyuan-Xue/PixelDone-windows/releases/download/v3.2.5/${fileName}`
    }
  }
}, null, 2)}\n`, 'utf8');
