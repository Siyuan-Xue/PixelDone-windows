...
const fileName = 'PixelDone_3.2.2_x64-setup.exe';
...
writeFileSync(join(directory, 'latest.json'), `${JSON.stringify({
  version: '3.2.2',
  notes: 'PixelDone for Windows 3.2.2 fixes the startup migration checksum regression in 3.2.1 without changing user data.',
  pub_date: new Date().toISOString(),
  platforms: {
    'windows-x86_64': {
      signature,
      url: `https://github.com/Siyuan-Xue/PixelDone-windows/releases/download/v3.2.2/${fileName}`
    }
  }
}, null, 2)}\n`, 'utf8');
