CREATE TABLE local_settings_expanded (
    ...
    sidebar_width_px INTEGER NOT NULL DEFAULT 320 CHECK (sidebar_width_px BETWEEN 200 AND 560)
);

INSERT INTO local_settings_expanded (
    id,
    dark_theme,
    dock_plus_placement,
    dock_actions_json,
...
ALTER TABLE local_settings_expanded RENAME TO local_settings;
