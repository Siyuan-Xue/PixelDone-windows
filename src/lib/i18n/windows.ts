...
const english = {
  ...
  deleteTodoDetail: 'This task will move to Trash and can still be restored later.',
  deleteCompletedDetail: 'The completed tasks in this checklist ({count}) will move to Trash and can still be restored later.',
  permanentlyDeleteTaskTitle: 'Permanently delete task?',
  permanentlyDeleteTodoDetail: 'This task will be permanently deleted and cannot be restored.',
  permanentlyDeleteTrashDetail: 'The tasks currently in Trash ({count}) will be permanently deleted and cannot be restored.',
  deleteLegacyTitle: 'Delete legacy data?',
  deleteLegacyDetail: 'The legacy Roaming database will be permanently deleted. The active Local database is not affected.',
  deleting: 'Deleting\u2026',
...
const translations: Record<Locale, Record<WindowsMessageKey, string>> = {
  ...
  'zh-Hans': {
    ...
    deleteTodoDetail: '\u6b64\u5f85\u529e\u5c06\u79fb\u81f3\u56de\u6536\u7ad9\uff0c\u4e4b\u540e\u4ecd\u53ef\u6062\u590d\u3002',
    deleteCompletedDetail: '\u5f53\u524d\u6e05\u5355\u4e2d\u7684 {count} \u9879\u5df2\u5b8c\u6210\u5f85\u529e\u5c06\u79fb\u81f3\u56de\u6536\u7ad9\uff0c\u4e4b\u540e\u4ecd\u53ef\u6062\u590d\u3002',
    permanentlyDeleteTaskTitle: '\u6c38\u4e45\u5220\u9664\u5f85\u529e\uff1f',
    permanentlyDeleteTodoDetail: '\u6b64\u5f85\u529e\u5c06\u88ab\u6c38\u4e45\u5220\u9664\uff0c\u4e14\u65e0\u6cd5\u6062\u590d\u3002',
    permanentlyDeleteTrashDetail: '\u56de\u6536\u7ad9\u4e2d\u5f53\u524d\u7684 {count} \u9879\u5f85\u529e\u5c06\u88ab\u6c38\u4e45\u5220\u9664\uff0c\u4e14\u65e0\u6cd5\u6062\u590d\u3002',
    deleteLegacyTitle: '\u5220\u9664\u65e7\u7248\u6570\u636e\uff1f',
    deleteLegacyDetail: '\u65e7\u7248 Roaming \u6570\u636e\u5e93\u5c06\u88ab\u6c38\u4e45\u5220\u9664\u3002\u5f53\u524d Local \u6570\u636e\u5e93\u4e0d\u4f1a\u53d7\u5230\u5f71\u54cd\u3002',
    deleting: '\u6b63\u5728\u5220\u9664\u2026',
    taskCount: '{count} \u9879\u5f85\u529e',
    taskCountOne: '{count} \u9879\u5f85\u529e',
  ...
  ar: {
    ...
    deleteTodoDetail: 'ستنقل هذه المهمة إلى سلة المحذوفات ويمكن استعادتها لاحقًا.',
    deleteCompletedDetail: 'ستنقل كل المهام المكتملة وعددها {count} في هذه القائمة إلى سلة المحذوفات ويمكن استعادتها لاحقًا.',
    permanentlyDeleteTaskTitle: 'حذف المهمة نهائيًا؟',
    permanentlyDeleteTodoDetail: 'ستُحذف هذه المهمة نهائيًا ولا يمكن استعادتها.',
    permanentlyDeleteTrashDetail: 'ستُحذف كل المهام الموجودة حاليًا في سلة المحذوفات وعددها {count} نهائيًا ولا يمكن استعادتها.',
    deleteLegacyTitle: 'حذف البيانات القديمة؟',
    deleteLegacyDetail: 'ستُحذف قاعدة بيانات Roaming القديمة نهائيًا. لن تتأثر قاعدة بيانات Local النشطة.',
    deleting: 'جارٍ الحذف…',
  ...
  fr: {
    ...
    deleteTodoDetail: 'Cette tâche sera placée dans la corbeille et pourra encore être restaurée.',
    deleteCompletedDetail: 'Les {count} tâches terminées de cette liste seront placées dans la corbeille et pourront encore être restaurées.',
    permanentlyDeleteTaskTitle: 'Supprimer définitivement la tâche ?',
    permanentlyDeleteTodoDetail: 'Cette tâche sera supprimée définitivement et ne pourra pas être restaurée.',
    permanentlyDeleteTrashDetail: 'Les {count} tâches actuellement dans la corbeille seront supprimées définitivement et ne pourront pas être restaurées.',
    deleteLegacyTitle: 'Supprimer les anciennes données ?',
    deleteLegacyDetail: 'L’ancienne base Roaming sera supprimée définitivement. La base Local active ne sera pas affectée.',
  ...
  ru: {
    ...
    deleteTodoDetail: 'Задача будет перемещена в корзину, откуда её можно будет восстановить.',
    deleteCompletedDetail: 'Все выполненные задачи этого списка ({count}) будут перемещены в корзину, откуда их можно будет восстановить.',
    permanentlyDeleteTaskTitle: 'Удалить задачу навсегда?',
    permanentlyDeleteTodoDetail: 'Задача будет удалена навсегда, и восстановить её будет невозможно.',
    permanentlyDeleteTrashDetail: 'Все задачи в корзине ({count}) будут удалены навсегда, и восстановить их будет невозможно.',
    deleteLegacyTitle: 'Удалить старые данные?',
    deleteLegacyDetail: 'Старая база Roaming будет удалена навсегда. Активная база Local не изменится.',
    deleting: 'Удаление…',
  ...
  es: {
    ...
    deleteTodoDetail: 'Esta tarea se moverá a la papelera y todavía podrá restaurarse.',
    deleteCompletedDetail: 'Las {count} tareas completadas de esta lista se moverán a la papelera y todavía podrán restaurarse.',
    permanentlyDeleteTaskTitle: '¿Eliminar la tarea permanentemente?',
    permanentlyDeleteTodoDetail: 'Esta tarea se eliminará permanentemente y no podrá restaurarse.',
    permanentlyDeleteTrashDetail: 'Las {count} tareas que hay en la papelera se eliminarán permanentemente y no podrán restaurarse.',
    deleteLegacyTitle: '¿Eliminar los datos antiguos?',
    deleteLegacyDetail: 'La base Roaming antigua se eliminará permanentemente. La base Local activa no se verá afectada.',
    deleting: 'Eliminando…',
