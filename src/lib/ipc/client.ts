...
let browserSnapshot: AppSnapshot = {
  ...
  update: { state: 'CURRENT', currentVersion: '3.2.1', availableVersion: null, downloadUrl: null, source: 'preview', message: null, downloadedBytes: 0, totalBytes: null, lastCheckedAtMillis: null, nextCheckAtMillis: null },
  checklists: [
    {
      id: 'main',
      name: 'MAIN',
